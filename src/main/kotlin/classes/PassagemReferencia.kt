...
fun main(args: Array<String>) {
     ...
     * Esse tipo de atribuição faz com que o "carro2" aponte para a mesma referência de "carro1",
     * sendo que qualquer alteração dos atribuitos de "carro2" afetará o "carro1" e o inverso
     * também é verdadeiro
     */
