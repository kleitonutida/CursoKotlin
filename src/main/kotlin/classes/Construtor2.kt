...
/*
 * Os parâmetros informados após o nome da classe, serão utilizados para determinar o construtor da classe
 * Neste construtor é possível utilizar os parâmetros nomeados e também informar um valor padrão para a
 * variável
 */
